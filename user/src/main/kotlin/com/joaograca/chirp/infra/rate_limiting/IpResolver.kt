package com.joaograca.chirp.infra.rate_limiting

import com.joaograca.chirp.config.NginxConfig
    ...
    fun getClientIp(request: HttpServletRequest): String {
        ...
        if (!isFromTrustedProxy(remoteAddr)) {
            if (nginxConfig.requireProxy) {
                logger.warn("Direct connection attempt from untrusted IP: $remoteAddr")
